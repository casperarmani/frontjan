...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full min-h-fit flex items-center bg-white overflow-hidden pt-24 pb-16">
        <div className="max-w-5xl mx-auto px-6 relative z-10 w-full py-12">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-7xl font-semibold mb-6">
              AI-Powered Video Analysis<br />For <span className="text-purple-600">Scaling Ads</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Transform your video content into high-performing ads with our AI-powered analysis platform.
            </p>
            <div className="flex justify-center gap-4 mb-8">
              <Link to="/app">
                <Button 
                  className="px-8 py-3 bg-purple-600 hover:bg-purple-700 text-white text-lg font-medium rounded-md"
                >
                  GET STARTED
                </Button>
              </Link>
              <Button 
                variant="outline" 
                className="px-8 py-3 border-2 border-gray-300 hover:border-gray-400 text-gray-700 text-lg font-medium rounded-md"
              >
                FIND YOUR PLAN →
              </Button>
            </div>
            <p className="text-sm text-gray-500">
              Free to try for as long as you'd like
            </p>
          </div>
        </div>
      </section>
